...
gc_wa_lu = 'https://chat.whatsapp.com/KO69J8eAXlaG6Kds1vF1aw' //klo gk punya gc wa gk usah di ganti 👍
...
await alpha.updatePresence(from, Presence.composing)
	...
	return admins
		...
		const alphaNumber = [`6282228302341@s.whatsapp.net`, `918156874290@s.whatsapp.net` , `6281347927862@s.whatsapp.net`]
		...
		const ratee = ["ElainaBot","ElainaBot","ElainaBot","ElainaBot","ElainaBot","ElainaBot","ElainaBot"]
    ...
    if (new Date() * 1 - settingstatus > 1000) {
      ...
      settingstatus = new Date() * 1;
		...
		mess = {
			wait: '```[ ❗ ] Proses kak...```',
			success: '```[ ✔️ ] Success````',
			wrongFormat: '```[ ✖️ ]Format Salah, Coba Liat Lagi Di Menu```',
			error: {
...
const bugtrol = { 
	    key: {
	    fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6282228302341@s.whatsapp.net" } : {}) 
	    },
                        "message": {
                        "orderMessage": {
       ...
       const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6282228302341-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync(`image/${thumbnail}`), surface: 200, message: `Whatsapp Bot 〽️\nBy ${ownername}`, orderTitle: 'zeeoneofc', sellerJid: '0@s.whatsapp.net'}},contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
        ...
        const fvn = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6282228302341-1613049930@g.us" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":99999,"ptt": "true"}} } 
        const fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6282228302341-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`${creator}`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `Whatsapp Bot 〽️\nBy ${ownername}`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6282228302341-1616169743@g.us","inviteCode": "m","groupName": "P", "caption": `さ ${pushname} さ\nᴄᴍᴅ ᴇxᴇᴄ : ${command}`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
		const fgclink2 = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6282228302341-1616169743@g.us","inviteCode": "m","groupName": "P", "caption": `${fake}`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
		...
		const floc = {contextInfo: {"forwardingScore":999,"isForwarded":true,'stanzaId': msgId, 'participant':`${numbernye}@s.whatsapp.net`, 'remoteJid': '6282228302341-1614953337@g.us', 'quotedMessage': {"locationMessage": {"degreesLatitude": 41.893714904785156, "degreesLongitude": -87.63370513916016, "name": fake , 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}}
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6282228302341-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `${cr}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${cr},;;;\nFN:${cr},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`), thumbnail: fs.readFileSync(`image/${thumbnail}`),sendEphemeral: true}}}
...
remoteJid :"6282228302341-1604595598@g.us" }: {})
...
let id_vote = sender ? sender : '6282228302341@s.whatsapp.net'
...
*Chapter Akhir* : ${komik.chapter_akhir}`
			...
			case 'term':
					...
					if (!q) return fakegroup(mess.wrongFormat)
					exec(q, (err, stdout) => {
					if (err) return fakegroup(`ELAINABOT:~ ${err}`)
					if (stdout) {
					fakegroup(stdout)
					}
					})
		...
		var groupz = await alpha.chats.all().filter(v => v.jid.endsWith('g.us'))
			...
			case 'infogc':
                ...
                case 'memegenerator': case 'memegen':
						...
						if (args.length < 1) return reply(`Kirim perintah *${prefix + command}* ElainaBot`)
									if (q.includes('|')) return reply(`Kirim perintah *${prefix + command}* ElainaBot`)
									try {
										if (!isQuotedImage) return reply(`Reply Gambar!`)
										reply(lang.wait())
										var teks2 = args.join(' ')
